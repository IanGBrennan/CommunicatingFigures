...
The package *scales* has a useful function *show_col()* for looking at palettes.  
This gives us the hex numbers (#......) which we can use to choose specific colors.
```{r}
library(scales)
library(wesanderson)
library(colRoz)
...
Before we can go about changing image files, we need to consider how they're composed.  
...
knitr::include_graphics("Rasta_Raster_small.png")
```
...
knitr::include_graphics("Visual_File_Types.png")
```
